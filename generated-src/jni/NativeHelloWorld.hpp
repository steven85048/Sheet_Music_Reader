...
class NativeHelloWorld final : ::djinni::JniInterface<::sheetmusicreader::HelloWorld, NativeHelloWorld> {
public:
...
private:
    ...
    friend ::djinni::JniInterface<::sheetmusicreader::HelloWorld, NativeHelloWorld>;
